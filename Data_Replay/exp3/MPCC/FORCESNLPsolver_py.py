...
a Python wrapper for a fast solver generated by FORCESPRO v6.0.1
   ...
   subject to the parameters supplied in the following dictionary:
       ...
       PARAMS['x0'] - matrix of size [270x1]
       PARAMS['all_parameters'] - matrix of size [3510x1]

   OUTPUT returns the values of the last iteration of the solver where
       OUTPUT['x01'] - column vector of length 9
       OUTPUT['x02'] - column vector of length 9
       OUTPUT['x03'] - column vector of length 9
       OUTPUT['x04'] - column vector of length 9
       OUTPUT['x05'] - column vector of length 9
       OUTPUT['x06'] - column vector of length 9
       OUTPUT['x07'] - column vector of length 9
       OUTPUT['x08'] - column vector of length 9
       OUTPUT['x09'] - column vector of length 9
       OUTPUT['x10'] - column vector of length 9
       OUTPUT['x11'] - column vector of length 9
       OUTPUT['x12'] - column vector of length 9
       OUTPUT['x13'] - column vector of length 9
       OUTPUT['x14'] - column vector of length 9
       OUTPUT['x15'] - column vector of length 9
       OUTPUT['x16'] - column vector of length 9
       OUTPUT['x17'] - column vector of length 9
       OUTPUT['x18'] - column vector of length 9
       OUTPUT['x19'] - column vector of length 9
       OUTPUT['x20'] - column vector of length 9
       OUTPUT['x21'] - column vector of length 9
       OUTPUT['x22'] - column vector of length 9
       OUTPUT['x23'] - column vector of length 9
       OUTPUT['x24'] - column vector of length 9
       OUTPUT['x25'] - column vector of length 9
       OUTPUT['x26'] - column vector of length 9
       OUTPUT['x27'] - column vector of length 9
       OUTPUT['x28'] - column vector of length 9
       OUTPUT['x29'] - column vector of length 9
       OUTPUT['x30'] - column vector of length 9
...
('x0', ctypes.c_double * 270),
('all_parameters', ctypes.c_double * 3510),
]
