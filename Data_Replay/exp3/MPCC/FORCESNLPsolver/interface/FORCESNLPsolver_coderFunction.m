...
% - x21 - column vector of length 9
% - x22 - column vector of length 9
% - x23 - column vector of length 9
% - x24 - column vector of length 9
% - x25 - column vector of length 9
% - x26 - column vector of length 9
% - x27 - column vector of length 9
% - x28 - column vector of length 9
% - x29 - column vector of length 9
% - x30 - column vector of length 9
function [x01, x02, x03, x04, x05, x06, x07, x08, x09, x10, x11, x12, x13, x14, x15, x16, x17, x18, x19, x20, x21, x22, x23, x24, x25, x26, x27, x28, x29, x30] = FORCESNLPsolver(xinit, x0, all_parameters)
